...
public class TEST_Jcl {
	...
	private static String[] argumentos = { " --ambiente DES --sistema SIAOI " };
	...
	public void test_sistema() {
		assertTrue("SIAOI".equals(artefato.getSistema()));
	}
	...
	public void test_steps() {
		...
		Artefato artefato01 = new Artefato("STEP01", "STEP01", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato02 = new Artefato("STEP02", "STEP02", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato03 = new Artefato("STEP03", "STEP03", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato04 = new Artefato("STEP04", "STEP04", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato05 = new Artefato("STEP05", "STEP05", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato06 = new Artefato("STEP06", "STEP06", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato07 = new Artefato("STEP07", "STEP07", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato08 = new Artefato("STEP08", "STEP08", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato09 = new Artefato("STEP09", "STEP09", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato10 = new Artefato("STEP10", "STEP10", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato11 = new Artefato("STEP11", "STEP11", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato12 = new Artefato("STEP12", "STEP12", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato13 = new Artefato("STEP13", "STEP13", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		Artefato artefato14 = new Artefato("STEP14", "STEP14", null, TipoArtefato.JCL_STEP, TipoAmbiente.PRD, "SIAOI", null,
				null, TipoRelacionamento.NORMAL);
		// ***
		// ***
	...
	public void test_declaracoes_sql() {
		...
		Artefato artefato01 = new Artefato("DECLARACAO-SQL-1", "DECLARACAO-SQL-1", null, TipoArtefato.DECLARACAO_SQL,
				TipoAmbiente.PRD, "SIAOI", null, null, TipoRelacionamento.NORMAL);
	...
	public void test_dsn() {
		...
		Artefato artefato01 = new Artefato("PCS.MZ.BZX0.MDA1B4C2.B446.S03.FRESPOK", "PCS.MZ.BZX0.MDA1B4C2.B446.S03.FRESPOK", null, TipoArtefato.DSN,
				TipoAmbiente.DESCONHECIDO, "SIAOI", null, null, TipoRelacionamento.NORMAL);
		...
		Artefato artefato20 = new Artefato("CNT.PCS.MZ.BGT1.IGAP0323.D%%ODATE", "CNT.PCS.MZ.BGT1.IGAP0323.D%%ODATE", null, TipoArtefato.DSN,
				TipoAmbiente.DESCONHECIDO, "SIAOI", null, null, TipoRelacionamento.INTERFACE);
		...
		Atributo atributo39_1 = new Atributo(TipoAtributo.SISTEMA_DESTINO, "SIAOI", null, Tabelas.TBL_RELACIONAMENTO_ARTEFATO.get());
		...
		Atributo atributo41_1 = new Atributo(TipoAtributo.SISTEMA_DESTINO, "SIAOI", null, Tabelas.TBL_RELACIONAMENTO_ARTEFATO.get());
		...
		Artefato artefato45 = new Artefato("CNT.PCS.MZ.BZX0.FRENCIX1.D%%ODATE.ZIP", "CNT.PCS.MZ.BZX0.FRENCIX1.D%%ODATE.ZIP", null, TipoArtefato.DSN,
				TipoAmbiente.DESCONHECIDO, "SIAOI", null, null, TipoRelacionamento.INTERFACE);
		Atributo atributo45_1 = new Atributo(TipoAtributo.SISTEMA_DESTINO, "SIAOI", null, Tabelas.TBL_RELACIONAMENTO_ARTEFATO.get());
		...
		Artefato artefato47 = new Artefato("CNT.PCS.MZ.BZX0.FRENCIX1.D%%ODATE", "CNT.PCS.MZ.BZX0.FRENCIX1.D%%ODATE", null, TipoArtefato.DSN,
				TipoAmbiente.DESCONHECIDO, "SIAOI", null, null, TipoRelacionamento.INTERFACE);
		Atributo atributo47_1 = new Atributo(TipoAtributo.SISTEMA_DESTINO, "SIAOI", null, Tabelas.TBL_RELACIONAMENTO_ARTEFATO.get());
		...
		Atributo atributo55_1 = new Atributo(TipoAtributo.SISTEMA_DESTINO, "SIAOI", null, Tabelas.TBL_RELACIONAMENTO_ARTEFATO.get());
